...
@Data
@Schema(description = "Info abouut cake")
@Validated
public class CakeFullInfo {
    ...
    @NotNull
    @Schema(description = "Url of image", required = true)
    @JsonProperty("image")
    ...
    @NotNull
    @Schema(description = "manufacturerName of cake", required = true)
    @JsonProperty("manufacturerName")
    private String manufacturerName;

    @NotNull
    @Schema(description = "storage conditions of cake", required = true)
